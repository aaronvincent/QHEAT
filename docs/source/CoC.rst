...
* Be polite and respectful: Keep in mind that behaviours acceptable to one person may not be so to another. In all forms of communication avoid language and jokes that can make others feel uncomfortable. If in doubt, play it safe.
* Be receptive: Help foster an open atmosphere where it is OK to point out if something is not OK. Be mindful that actions and words can make others uncomfortable even when that is not even remotely the intent. Respond sensitively and with empathy to such reports.
* Recognise that each person will have their own interpretations of, thoughts and opinions on specific interactions between group members, and that these will likely be influenced by their past experiences. Recognise these as valid, even if they conflict with your own or those of other members, and try to be accommodating of them.

In the QHEAT we do not tolerate harassment, intimidation, bullying, discrimination, or any other form of mistreatment. As community members, each of us has a responsibility to take action if we observe conduct unacceptable by our code of conduct. Such actions may include:
...
* discussing the situation with another member of the department (e.g. head, another faculty member that you trust), or McDonald Institute staff.
* any such discussion is treated as confidential by default, unless explicit permission is given to share bring your concerns to another party.

In most cases, the preferred first course of action should be the gentle conversation. However, this necessarily depends on the nature of the observed misconduct, and must be judged on a case by case basis. We do not tolerate any retaliation against group members who report or participate in an investigation of a possible violation of our code of conduct, policies, or the law.
